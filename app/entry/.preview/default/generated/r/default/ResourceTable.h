...
const int32_t MEDIA_MAP_CULTURE = 0x01000007;
const int32_t MEDIA_MAP_FAMILY = 0x01000009;
const int32_t MEDIA_MAP_LEISURE = 0x01000008;
const int32_t PROFILE_MAIN_PAGES = 0x01000000;
}
#endif